...
pub(super) fn is_star_reexport<M: Default + Clone + PartialEq>(sym: &Symbol<M>) -> bool {
    sym.name == "*"
}

/// Create a StructuralChange from common fields.
pub(super) fn change<M: Default + Clone + PartialEq>(
    sym: &Symbol<M>,
...
pub(super) fn symbol_summary<M: Default + Clone + PartialEq>(sym: &Symbol<M>) -> String {
